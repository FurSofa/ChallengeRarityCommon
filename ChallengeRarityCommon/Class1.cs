...
[assembly: MelonInfo(typeof(ChallengeRarity.Main), "ChallengeOnlyCommon", "1.0.0", "Fur")]
...
public class ChallengeOnlyCommon : MelonMod
{
    ...
    class LuckPatch
    {
        ...
        {
            itemRarities = new List<Item2.Rarity> { Item2.Rarity.Common };
